module SisimaiLegacy
  # SisimaiLegacy::ARF is a parser for email returned as a FeedBack Loop report message.
  module ARF
    ...
    class << self
      ...
      LongFields = SisimaiLegacy::RFC5322.LONGFIELDS
      ...
      def scan(mhead, mbody)
        ...
        while e = hasdivided.shift do
          ...
          if readcursor & Indicators[:'message-rfc822'] > 0
            ...
            if cv = e.match(/X-HmXmrOriginalRecipient:[ ]*(.+)\z/)
              ...
              dscontents[-1]['recipient'] = SisimaiLegacy::Address.s3s4(cv[1])
              recipients += 1
              ...
              commondata[:from] = SisimaiLegacy::Address.s3s4(cv[1]) if commondata[:from].empty?
        ...
        unless recipients > 0
          ...
          dscontents[-1]['recipient'] = SisimaiLegacy::Address.undisclosed(:r)
          recipients = 1
        end
        ...
        dscontents.each do |e|
          if e['recipient'] =~ /\A[^ ]+[@]\z/
            ...
            e['recipient'] = SisimaiLegacy::Address.s3s4(rcptintext)
          end
