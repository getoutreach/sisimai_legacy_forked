module SisimaiLegacy::Bite::Email
  # SisimaiLegacy::Bite::Email::McAfee parses a bounce email which created by McAfee
  # Email Appliance. Methods in the module are called from only SisimaiLegacy::Message.
  module McAfee
    class << self
      ...
      def scan(mhead, mbody)
        ...
        while e = hasdivided.shift do
          ...
          if readcursor & Indicators[:'message-rfc822'] > 0
            ...
            if cv = e.match(/\A[<]([^ ]+[@][^ ]+)[>][ \t]+[(](.+)[)]\z/)
              ...
              v['alias'] = SisimaiLegacy::Address.s3s4(cv[1])
        ...
        dscontents.each do |e|
          e['agent']     = smtpagent
          e['diagnosis'] = SisimaiLegacy::String.sweep(e['diagnosis'] || diagnostic)
