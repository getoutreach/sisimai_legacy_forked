module SisimaiLegacy::Bite::Email
  # SisimaiLegacy::Bite::Email::MailFoundry parses a bounce email which created by
  # MailFoundry. Methods in the module are called from only SisimaiLegacy::Message.
  module MailFoundry
    class << self
