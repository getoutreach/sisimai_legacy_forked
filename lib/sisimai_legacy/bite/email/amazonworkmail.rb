module SisimaiLegacy::Bite::Email
  # SisimaiLegacy::Bite::Email::AmazonWorkMail parses a bounce email which created by
  # Amazon WorkMail. Methods in the module are called from only SisimaiLegacy::Message.
