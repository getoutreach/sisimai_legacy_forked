  ...
  describe '.to_second' do
    context 'integer + supported unit string' do
      it 'returns converted seconds value' do
        expect(SisimaiLegacy::DateTime.to_second('1d')).to be == 86400
        expect(SisimaiLegacy::DateTime.to_second('2w')).to be == 86400 * 7 * 2
        expect(SisimaiLegacy::DateTime.to_second('3f')).to be == 86400 * 14 * 3
        expect(SisimaiLegacy::DateTime.to_second('4l').to_i).to be == 10205771
        expect(SisimaiLegacy::DateTime.to_second('5q').to_i).to be == 39446190
        expect(SisimaiLegacy::DateTime.to_second('6y')).to be == 189341712
        expect(SisimaiLegacy::DateTime.to_second('7o')).to be == 883594656
      end
    end

    context 'integer alias string + supported unit string' do
      it 'returns converted seconds value' do
        expect(SisimaiLegacy::DateTime.to_second('gs').to_i).to be == 23
        expect(SisimaiLegacy::DateTime.to_second('pm').to_i).to be == 188
        expect(SisimaiLegacy::DateTime.to_second('eh').to_i).to be == 9785
      end
    end

    context 'negative integer OR unsupported unit string' do
      it 'always returns 0' do
        expect(SisimaiLegacy::DateTime.to_second(-1)).to be ==  0
        expect(SisimaiLegacy::DateTime.to_second(-4294967296)).to be ==  0
        expect(SisimaiLegacy::DateTime.to_second('1x')).to be == 0
        expect(SisimaiLegacy::DateTime.to_second(nil)).to be == 0
      end
    end

    context 'wrong number of arguments' do
      it 'raises ArgumentError' do
        expect { SisimaiLegacy::DateTime.to_second('x', 'y') }.to raise_error(ArgumentError)
        expect { SisimaiLegacy::DateTime.to_second('x', 'y', 'z') }.to raise_error(ArgumentError)
      end
    end
  end

  describe '.monthname' do
    month0 = SisimaiLegacy::DateTime.monthname(0)
    month1 = SisimaiLegacy::DateTime.monthname(1)
    ...
    context 'wrong number of arguments' do
      it 'raises ArgumentError' do
        expect { SisimaiLegacy::DateTime.monthname('x') }.to raise_error(ArgumentError)
        expect { SisimaiLegacy::DateTime.monthname('x','y') }.to raise_error(ArgumentError)
      end
    end
  end

  describe '.dayofweek' do
    dayofweek0 = SisimaiLegacy::DateTime.dayofweek(0)
    dayofweek1 = SisimaiLegacy::DateTime.dayofweek(1)
    ...
    context 'wrong number of arguments' do
      it 'raises ArgumentError' do
        expect { SisimaiLegacy::DateTime.dayofweek('x') }.to raise_error(ArgumentError)
        expect { SisimaiLegacy::DateTime.dayofweek('x', 'y') }.to raise_error(ArgumentError)
      end
    end
  end

  describe '.hourname' do
    hourname1 = SisimaiLegacy::DateTime.hourname(1)
    ...
    context 'wrong number of arguments' do
      it 'raises ArgumentError' do
        expect { SisimaiLegacy::DateTime.hourname('x') }.to raise_error(ArgumentError)
        expect { SisimaiLegacy::DateTime.hourname('x', 'y') }.to raise_error(ArgumentError)
      end
    end
  end
  ...
  describe 'parse' do
    context 'valid date string' do
      ...
      datestrings.each do |e|
        text = SisimaiLegacy::DateTime.parse(e)
  ...
  describe '.abbr2tz' do
    context 'valid timezone abbreviation string' do
      ...
      it 'returns timezone offset value' do
        tzmap.each do |x,y|
          expect(SisimaiLegacy::DateTime.abbr2tz(x)).to be == y
        end
      end
    end
    ...
    context 'invalid argument' do
      it 'always returns nil' do
        expect(SisimaiLegacy::DateTime.abbr2tz(0)).to be nil
        expect(SisimaiLegacy::DateTime.abbr2tz('a')).to be nil
      end
    end

    context 'wrong number of arguments' do
      it 'raises ArgumentError' do
        expect { SisimaiLegacy::DateTime.abbr2tz }.to raise_error(ArgumentError)
        expect { SisimaiLegacy::DateTime.abbr2tz(nil, nil) }.to raise_error(ArgumentError)
      end
    end
  ...
  describe '.tz2second' do
    context 'valid timezone offset string' do
      ...
      it 'returns timezome offset value(second)' do
        tzmap.each do |x,y|
          expect(SisimaiLegacy::DateTime.tz2second(x)).to be == y
        end
      end
    end
    ...
    context 'invalid argument' do
      context 'Out of Range' do
        it 'always returns nil' do
          expect(SisimaiLegacy::DateTime.tz2second('-1800')).to be nil
          expect(SisimaiLegacy::DateTime.tz2second('+1800')).to be nil
        end
      end
      ...
      context 'not timezone offset' do
        it 'always returns nil' do
          expect(SisimaiLegacy::DateTime.tz2second('nil')).to be nil
          expect(SisimaiLegacy::DateTime.tz2second(nil)).to be nil
        end
      end
    end
    ...
    context 'wrong number of arguments' do
      it 'raises ArgumentError' do
        expect { SisimaiLegacy::DateTime.tz2second }.to raise_error(ArgumentError)
        expect { SisimaiLegacy::DateTime.tz2second(nil, nil) }.to raise_error(ArgumentError)
      end
    end
  end
end
