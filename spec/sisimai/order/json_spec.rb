...
describe SisimaiLegacy::Order::JSON do
  ...
  describe '.default' do
    ...
    it 'have values' do
      # pending 'SisimaiLegacy::Bite::JSON::* are not implemented yet'
  ...
  describe '.another' do
    ...
    another.each do |e|
      ...
      it('has a module name') { expect(e.to_s).to match(/\ASisimaiLegacy::Bite::JSON::/) }
    end
  end
  describe '.headers' do
    headers = cn.headers
  ...
  describe '.by("keyname")' do
    ...
    orderby.each_key do |e|
      ...
      orderby[e].each do |f|
        ...
        it('is a module name') { expect(f).to match(/\ASisimaiLegacy::Bite::JSON::/) }
      end
    end
  end
end
