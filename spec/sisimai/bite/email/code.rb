        ...
        class << self
          ...
          def maketest(enginename=nil, isexpected=[], privateset=nil, onlydebugs=false)
            ...
            if outofemail.include? enginename
              ...
              # Other MTA modules
              require sprintf("sisimai_legacy/bite/email/%s", enginename.downcase)
              modulename = Module.const_get(sprintf("SisimaiLegacy::Bite::Email::%s", enginename))
            ...
            isexpected.each do |e|
              ...
              describe sprintf("%s[%s]", enginename, e['n']) do
                ...
                mailobject = SisimaiLegacy::Mail.new(samplefile)
                next unless mailobject.path

                it('could be generated SisimaiLegacy::Mail object') { expect(mailobject).to be_a SisimaiLegacy::Mail }
                ...
                while r = mailobject.read do
                  ...
                  describe SisimaiLegacy::Mail do
                    ...
                    mesgobject = SisimaiLegacy::Message.new(data: r, input: 'email')
